...
[![License](https://img.shields.io/github/license/Major-Woolfi/{REPO_NAME})](LICENSE)
...
[🐛 Сообщить о баге](https://github.com/Major-Woolfi/{REPO_NAME}/issues/new) •
[💡 Предложить идею](https://github.com/Major-Woolfi/{REPO_NAME}/discussions)
...
git clone https://github.com/Major-Woolfi/{REPO_NAME}.git
cd {REPO_NAME}
```
...
docker run -d --name {REPO_NAME} --env-file .env {REPO_NAME}
```
...
| Метрика        | Значение                                                                                                                                                |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ⭐ Stars        | [![Stars](https://img.shields.io/github/stars/Major-Woolfi/{REPO_NAME})](https://github.com/Major-Woolfi/{REPO_NAME}/stargazers)                        |
| 🍴 Forks        | [![Forks](https://img.shields.io/github/forks/Major-Woolfi/{REPO_NAME})](https://github.com/Major-Woolfi/{REPO_NAME}/network/members)                   |
| 🐛 Issues       | [![Issues](https://img.shields.io/github/issues/Major-Woolfi/{REPO_NAME})](https://github.com/Major-Woolfi/{REPO_NAME}/issues)                          |
| 👥 Contributors | [![Contributors](https://img.shields.io/github/contributors/Major-Woolfi/{REPO_NAME})](https://github.com/Major-Woolfi/{REPO_NAME}/graphs/contributors) |
...
<a href="https://github.com/Major-Woolfi/{REPO_NAME}/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=Major-Woolfi/{REPO_NAME}" />
</a>
